...
CREATE TABLE `mcp_gateway` (
                               ...
                               `gateway_description` varchar(512) DEFAULT NULL COMMENT '网关描述',
...
INSERT INTO `mcp_gateway` (`id`, `gateway_id`, `gateway_name`, `gateway_description`, gateway_version, `auth`, `status`, `create_time`, `update_time`)
VALUES
...
CREATE TABLE `mcp_protocol_mapping` (
                                        ...
                                        `mcp_description` varchar(512) DEFAULT NULL COMMENT 'MCP字段描述',
...
INSERT INTO `mcp_protocol_mapping` (`id`, `protocol_id`, `mapping_type`, `parent_path`, `field_name`, `mcp_path`, `mcp_type`, `mcp_description`, `is_required`, `sort_order`, `create_time`, `update_time`)
VALUES
