...
public class McpGatewayDaoTest {
    ...
    public void testInsert() {
        McpGatewayPO po = McpGatewayPO.builder()
                ...
                .gatewayName("测试网关001")
                .gatewayDescription("这是一个测试网关的描述信息")
                .status(1)
                .build();
    ...
    public void testQueryById() {
        McpGatewayPO po = McpGatewayPO.builder()
                                      ...
                                      .gatewayName("测试网关002")
                                      .gatewayDescription("这是另一个测试网关的描述信息")
                                      .status(1)
                                      .build();
        ...
        assertEquals("网关描述应该匹配", "这是另一个测试网关的描述信息", result.getGatewayDescription());
    ...
    public void testUpdateById() {
        ...
        assertEquals("网关描述应该更新", "这是更新后的描述信息", updated.getGatewayDescription());
    ...
    public void testInsertWithNullDescription() {
        McpGatewayPO po = McpGatewayPO.builder()
                ...
                .gatewayName("测试网关无描述")
                .gatewayDescription(null) // 描述为null
                .status(1)
                .build();
        ...
        assertNull("描述应该为null", queryResult.getGatewayDescription());
