...
public abstract class AbstractMcpSessionSupport extends AbstractMultiThreadStrategyRouter<String,
        DefaultMcpMessageFactory.DynamicContext, Flux<ServerSentEvent<String>>> {
     ...
     */
    @Override
    protected void multiThread(String request, DefaultMcpMessageFactory.DynamicContext context) throws Exception {
        // 会话创建链路为同步流程，无需并发处理
    }
}